  ...
  return (
    <Transition>
      <main className={`${darkMode ? 'tw-text-white' : 'tw-text-black'}
                        ...
                        ${isDesktopMDXL && 'tw-grid-cols-layout-home-xl tw-grid-rows-layout-home-xl'} 
        ...
        <article className={`${isMobile ? 'tw-border-t': 'tw-border-x'} tw-h-full tw-w-full 
            ...
            {/**Information */}
            <section className={ `${darkMode ? "tw-bg-neutral-700 tw-border-gray-300" : "tw-bg-gray-100 tw-border-jazicorn-pink-200"} tw-w-full tw-py-16 tw-border-y tw-z-100 tw-absolute tw-place-items-center tw-items-center`}>
              <div className={`${darkMode ? "" : ""}`}>
              ...
              <div className={`${isMobile && 'tw-text-sm '} ${isDesktopMDXL && 'tw-text-base'} ${isDesktopXL && 'tw-text-lg'}  tw-mt-8`}>
